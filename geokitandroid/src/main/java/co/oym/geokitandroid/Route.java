...
public class Route {
	...
	public static class Utility {
		...
		public static String render2(Instruction i, android.content.res.Resources res) {
			if (res == null)
		...
		/**
		 * Return a full textual route instruction for a given Route.Instruction object and language.
		 *
		 * @param i
		 * @param res
		 * @return
		 * @deprecated
		 */
		public static String render(Instruction i, android.content.res.Resources res) {
			if (res == null)
				return "no available resources"; //res = com.oym.android.impl.GeoKitContext.getContext().getResources();
			...
			if (manType.equals("HEAD")) {
				sb.append(res.getText(R.string.instr_15) + "");
				if (manHeading.equals("N")) sb.append(res.getString(R.string.instr_1));
				if (manHeading.equals("NE")) sb.append(res.getString(R.string.instr_2));
				if (manHeading.equals("E")) sb.append(res.getString(R.string.instr_3));
				if (manHeading.equals("SE")) sb.append(res.getString(R.string.instr_4));
				if (manHeading.equals("S")) sb.append(res.getString(R.string.instr_5));
				if (manHeading.equals("SW")) sb.append(res.getString(R.string.instr_6));
				if (manHeading.equals("W")) sb.append(res.getString(R.string.instr_7));
				if (manHeading.equals("NW")) sb.append(res.getString(R.string.instr_8));
				sb.append("");
				if (manRd != null || manRdnr != null)
					sb.append(res.getString(R.string.instr_16) + "" + decodeRoad(manRd, manRdnr) + "");
				if (manBranch != null)
					sb.append(res.getString(R.string.instr_17) + "" + decodeBranch(manBranch) + "");

			} else if (manType.equals("CONTINUE")) {
				sb.append(res.getString(R.string.instr_18));
				if (manRd != null || manRdnr != null)
					sb.append(res.getString(R.string.instr_19) + "" + decodeRoad(manRd, manRdnr) + "");
				if (isAd) {
					sb.append(" - ");
					if (adBridge != null) sb.append(res.getString(R.string.instr_20) + adBridge);
					if (adRoundAbout != null)
						sb.append(res.getString(R.string.instr_21) + "" + adRoundAbout + "" + res.getString(R.string.instr_22));
					if (adTunnel != null)
						sb.append(res.getString(R.string.instr_23) + "" + adTunnel + "");
					if (adCross != null)
						sb.append(res.getString(R.string.instr_24) + "" + adCross + "");
					if (adPassBy != null)
						sb.append(res.getString(R.string.instr_28) + "" + adPassBy + "");
				}

			} else if (manType.equals("TURN")) {
				sb.append(res.getString(R.string.instr_26) + "" + decodeHeading(manHeading, res) + "");
				if (manBranch != null)
					sb.append(res.getString(R.string.instr_27) + "" + decodeBranch(manBranch) + "");
				else if (manRd != null || manRdnr != null)
					sb.append(res.getString(R.string.instr_28) + "" + decodeRoad(manRd, manRdnr) + "");

				if (adContinue != null)
					sb.append(res.getString(R.string.instr_29) + "" + decodeRoad(adContinue, null) + "");
				if (adStay != null && adStay.equals("YES"))
					sb.append(res.getString(R.string.instr_30) + "" + decodeRoad(null, manRdnr) + "");

			} else if (manType.equals("UTURN")) {
				sb.append("");

			} else if (manType.equals("KEEPLEFT") || manType.equals("KEEPRIGHT")) {
				sb.append(res.getString(R.string.instr_49) + "");
				sb.append((manType.equals("KEEPLEFT") ? res.getString(R.string.instr_50) : res.getString(R.string.instr_51)));
				sb.append("" + res.getString(R.string.instr_52));
				if (manDir != null)
					sb.append("," + res.getString(R.string.instr_53) + "" + decodeDirection(manDir) + "");
				if (manBranch != null) {
					sb.append("," + res.getString(R.string.instr_54) + "" + decodeBranch(manBranch) + "");
				} else if (manRd != null || manRdnr != null) {
					sb.append("," + res.getString(R.string.instr_54) + "" + decodeRoad(manRd, manRdnr) + "");
				}

				if (adToll != null) sb.append(" - " + res.getString(R.string.instr_55));

			} else if (manType.equals("ROUNDABOUT")) {
				sb.append(res.getString(R.string.instr_32) + "");
				if (manRd != null || manRdnr != null) {
					sb.append(decodeRoad(manRd, manRdnr));
				} else {
					sb.append(res.getString(R.string.instr_33));
				}

				sb.append("," + res.getString(R.string.instr_34) + "");
				if (adExitNum.equals("1")) sb.append(res.getString(R.string.instr_35));
				if (adExitNum.equals("2")) sb.append(res.getString(R.string.instr_36));
				if (adExitNum.equals("3")) sb.append(res.getString(R.string.instr_37));
				if (adExitNum.equals("4")) sb.append(res.getString(R.string.instr_38));
				if (adExitNum.equals("5")) sb.append(res.getString(R.string.instr_39));
				if (adExitNum.equals("6")) sb.append(res.getString(R.string.instr_40));
				if (adExitNum.equals("7")) sb.append(res.getString(R.string.instr_41));
				if (adExitNum.equals("8")) sb.append(res.getString(R.string.instr_42));
				if (adExitNum.equals("9")) sb.append(res.getString(R.string.instr_43));
				sb.append(res.getString(R.string.instr_44) + "");
				if (adExitRd != null || adExitRdnr != null) {
					sb.append(res.getString(R.string.instr_45) + "" + decodeRoad(adExitRd, adExitRdnr) + "");
				}

			} else if (manType.equals("RAMP")) {
				sb.append(res.getString(R.string.instr_46));
				if (manBranch != null) {
					sb.append(res.getString(R.string.instr_47) + "" + decodeBranch(manBranch) + "");
				} else if (manRd != null || manRdnr != null) {
					sb.append(res.getString(R.string.instr_47) + "" + decodeRoad(manRd, manRdnr) + "");
				}
				if (manDir != null)
					sb.append(res.getString(R.string.instr_48) + "" + decodeDirection(manDir) + "");

			} else if (manType.equals("MERGE")) {
				if (manRd != null || manRdnr != null || manDir != null) {
					sb.append(res.getString(R.string.instr_58) + "");
					sb.append(decodeHeading(manHeading, res) + "");
					if (manRd != null || manRdnr != null)
						sb.append(res.getString(R.string.instr_59) + "" + decodeRoad(manRd, manRdnr) + "");
					if (manDir != null)
						sb.append(res.getString(R.string.instr_60) + "" + decodeDirection(manDir) + "");
				} else {
					sb.append(res.getString(R.string.instr_61));
				}

			} else if (manType.equals("EXIT")) {
				sb.append(res.getString(R.string.instr_56) + "" + adExitNum + "");
				if (manDir != null)
					sb.append(res.getString(R.string.instr_57) + "" + decodeDirection(manDir) + "");


			} else if (manType.equals("EMBARK")) {
				sb.append(res.getString(R.string.instr_70) + decodeTransportType(adPtType) + " " + adPtName + "");
				if (adPtDir != null) sb.append(res.getString(R.string.instr_71) + "" + adPtDir + "");
				if (adPtStop != null)
					sb.append(res.getString(R.string.instr_72) + "" + adPtStop + "");
				if (adPtDelay != null)
					sb.append(" (" + res.getString(R.string.instr_73) + renderTime(adPtDelay, res) + ")");


			} else if (manType.equals("CHANGE")) {
				sb.append(res.getString(R.string.instr_74) + decodeTransportType(adPtType) + " " + adPtName + "");
				if (adPtDir != null) sb.append(res.getString(R.string.instr_75) + "" + adPtDir + "");
				if (adPtStop != null)
					sb.append(res.getString(R.string.instr_76) + "" + adPtStop + "");
				if (adPtDelay != null)
					sb.append(" (" + res.getString(R.string.instr_77) + renderTime(adPtDelay, res) + ")");


			} else if (manType.equals("DISEMBARK")) {
				sb.append(res.getString(R.string.instr_78) + "" + decodeRoad(manRd, manRdnr) + "");
				...
				sb.append(res.getString(R.string.instr_68));
				if (manRd != null || manRdnr != null)
					sb.append(res.getString(R.string.instr_69) + "" + decodeRoad(manRd, manRdnr) + "");

			} else if (manType.equals("END")) {
				sb.append(res.getString(R.string.instr_31));
			}
			return sb.toString();
		}
		...
		private static String renderTime(String time, android.content.res.Resources res) {
			String t = "";
			int tmp = Integer.parseInt(time) / 60;
			if (tmp > 0) {
				if (tmp == 1) t += "1 " + res.getString(R.string.instr_79);
				else t += tmp + " " + res.getString(R.string.instr_80);
				t += " ";
			}
			tmp = Integer.parseInt(time) % 60;
			if (tmp <= 1) t += "1 " + res.getString(R.string.instr_81);
			else t += tmp + " " + res.getString(R.string.instr_82);
